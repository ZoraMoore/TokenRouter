...
func (r *oauthPendingFlowRedeemCodeRepo) CreateUsage(ctx context.Context, usage *service.RedeemCodeUsage) error {
...
func (r *oauthPendingFlowRedeemCodeRepo) GetUsageByRedeemCodeAndUser(ctx context.Context, redeemCodeID, userID int64) (*service.RedeemCodeUsage, error) {
...
func (r *oauthPendingFlowUserRepo) CreateWithNormalizedEmailGuard(ctx context.Context, user *service.User, _ string) error {
...
func (r *oauthPendingFlowUserRepo) ExistsByNormalizedEmail(ctx context.Context, normalizedEmail string) (bool, error) {
	...
	for _, user := range users {
		if service.NormalizeRegistrationEmailAddress(user.Email) == normalizedEmail {
			return true, nil
		}
	}
	return false, nil
