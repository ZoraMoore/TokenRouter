...
func (r *contentModerationTestUserRepo) CreateWithNormalizedEmailGuard(ctx context.Context, user *User, normalizedEmail string) error {
...
func (r *contentModerationTestUserRepo) ExistsByNormalizedEmail(ctx context.Context, normalizedEmail string) (bool, error) {
	panic("unexpected ExistsByNormalizedEmail call")
}

func (r *contentModerationTestUserRepo) LockRegistrationEmail(ctx context.Context, normalizedEmail string) error {
...
func TestExtractContentModerationInput_OpenAIImagesIncludesPromptAndSamplesImage(t *testing.T) {
	images := []string{"https://example.com/source.png", "data:image/png;base64,aGVsbG8="}
	body := []byte(`{
