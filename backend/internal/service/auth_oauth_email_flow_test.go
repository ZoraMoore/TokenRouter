...
func (s *redeemCodeRepoStub) CreateUsage(context.Context, *RedeemCodeUsage) error {
	panic("unexpected CreateUsage call")
}

func (s *redeemCodeRepoStub) GetUsageByRedeemCodeAndUser(context.Context, int64, int64) (*RedeemCodeUsage, error) {
	return nil, nil
}
