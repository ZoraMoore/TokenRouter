...
function methodIcon(type: string): string {
  ...
  if (type === 'usdt_bep20') return METHOD_ICONS.usdt_bep20
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'usdt_bep20') return 'border-[#26A17B] bg-emerald-50 text-gray-900 shadow-sm dark:bg-emerald-950 dark:text-gray-100'
