export default {
  ...
  redeem: {
    ...
    codeRule1: 'A redeem code may support redemption by multiple users',
    codeRule2: 'The same user can only redeem the same code once successfully',
    codeRule3: 'Codes may add balance, increase concurrency, grant subscription access, and may also expire',
    codeRule4: 'Contact support if you have issues redeeming a code',
  ...
  admin: {
    ...
    redeem: {
      ...
      deleteAllUnusedConfirm:
        'Are you sure you want to delete all never-redeemed codes? This action cannot be undone.',
      ...
      amount: 'Amount',
      value: 'Value',
      maxUses: 'Redemption Limit',
      maxUsesHint: 'Set to 0 for unlimited redemptions.',
      maxUsesRequired: 'Redemption limit must be an integer greater than or equal to 0',
      expiresAt: 'Expires At',
      ...
      codesDeleted: 'Successfully deleted {count} never-redeemed code(s)',
      noUnusedCodes: 'No never-redeemed codes to delete',
    ...
    settings: {
      ...
      payment: {
        ...
        field_fiat: 'Fiat currency',
        field_timeout: 'Order timeout seconds',
        field_tradeType: 'Trade type',
        ...
        field_bepusdtTimeoutHint: 'Default 1800 seconds. Keep this aligned with the BEpusdt order expiration policy.',
        field_bepusdtTradeTypeHint: 'Fixed to usdt.bep20 for USDT BEP20 collection.',
        ...
        bepusdtWebhookHint: 'Configure the following URL as the BEpusdt asynchronous notify URL:',
  ...
  payment: {
    ...
    result: {
      ...
      redeemCode: 'Redeem Code',
      redeemCodeHint: 'Use this code on the redeem page to claim the purchased benefit.',
