export default {
  ...
  redeem: {
    ...
    newConcurrency: '新并发数',
    aboutCodes: '关于兑换码',
    codeRule1: '兑换码可能支持多人兑换',
    codeRule2: '同一用户对同一兑换码只能成功兑换一次',
    codeRule3: '兑换码可增加余额、并发数或订阅权限，也可能设置过期时间',
    codeRule4: '如有兑换问题，请联系客服',
    recentActivity: '最近活动',
  ...
  admin: {
    ...
    redeem: {
      ...
      value: '面值',
      maxUses: '兑换次数',
      maxUsesHint: '填写 0 表示无兑换次数上限。',
      maxUsesRequired: '兑换次数必须为大于等于 0 的整数',
      expiresAt: '过期时间',
      neverExpires: '不过期',
      count: '数量',
      generate: '生成',
      ...
      codeDeleted: '兑换码删除成功',
      codesDeleted: '成功删除 {count} 个从未兑换的兑换码',
      noUnusedCodes: '没有从未兑换的兑换码可删除',
      userPrefix: '用户 #{id}',
    ...
    ops: {
      ...
      settings: {
        ...
        retentionDaysHint: '建议保留7-90天，过长会占用存储空间；设为 0 表示每次定时清理都会清空全部历史数据',
        aggregation: '预聚合任务',
    ...
    settings: {
      ...
      payment: {
        ...
        field_currency: '支付币种',
        field_fiat: '法币币种',
        field_timeout: '订单超时秒数',
        field_tradeType: '交易类型',
        ...
        field_bepusdtTimeoutHint: '默认 1800 秒，请与 BEpusdt 订单过期策略保持一致。',
        field_bepusdtTradeTypeHint: '固定为 usdt.bep20，用于 USDT BEP20 收款。',
        ...
        bepusdtWebhookHint: '请在 BEpusdt 后台将以下地址配置为异步通知地址：',
  ...
  payment: {
    ...
    result: {
      ...
      failed: '支付失败',
      redeemCode: '兑换码',
      redeemCodeHint: '请在兑换页面使用该兑换码领取本次购买的权益。',
      backToRecharge: '返回充值',
      viewOrders: '查看订单',
    },
    currentBalance: '当前余额',
